...
<p>If you want to use the server only locally for your own phone, no need to create hotspot and you can access the web application via <a href="https://127.0.0.1:8443/">https://127.0.0.1:8443/</a> address. </p>
